!function (e, t) {
    ...
    var e, t, i,
        f = (i = Error, r(e = s, t = i), void (e.prototype = null === t ? Object.create(t) : (o.prototype = t.prototype, new o)), s);
    ...
    var k = ((E = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", E["bad-app-name"] = "Illegal App name: '{$appName}", E["duplicate-app"] = "Firebase App named '{$appName}' already exists", E["app-deleted"] = "Firebase App named '{$appName}' already deleted", E["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", E),
        w = new a("app", "Firebase", k), R = "[DEFAULT]",
        L = (Object.defineProperty(T.prototype, "automaticDataCollectionEnabled", {
            ...
            return new Promise(function (e) {
                ...
                for (var e = [], t = 0, r = Object.keys(a.services_); t < r.length; t++) for (var n = r[t], i = 0, o = Object.keys(a.services_[n]); i < o.length; i++) {
                    var s = o[i];
            ...
            if (this.isDeleted_) throw w.create("app-deleted", {appName: this.name_})
        }, T);
    ...
    var I = "7.2.1", j = new O("@firebase/app");
    ...
    function D(s) {
        var o = {}, a = {}, c = {}, l = {
            __esModule: !0, initializeApp: function (e, t) {
                ...
                var n = r.name;
                if ("string" != typeof n || !n) throw w.create("bad-app-name", {appName: String(n)});
                if (d(o, n)) throw w.create("duplicate-app", {appName: n});
                var i = new s(e, r, l);
                return f(o[n] = i, "create"), i
            }, app: p, apps: null, SDK_VERSION: I, INTERNAL: {
                registerService: function (r, e, t, n, i) {
                    ...
                    function o(e) {
                        if (void 0 === e && (e = p()), "function" != typeof e[r]) throw w.create("invalid-app-argument", {appName: r});
                        return e[r]()
                    }
        ...
        return l.default = l, Object.defineProperty(l, "apps", {get: u}), p.App = s, l
    }
    ...
    var S = function e() {
        ...
        return t.INTERNAL = n(n({}, t.INTERNAL), {
            createFirebaseNamespace: e, extendNamespace: function (e) {
                v(t, e)
            }, createSubscribe: l, ErrorFactory: a, deepExtend: v
        }), t
    }(), P = S.initializeApp;
